...
modelFoto = "foto2"  # "foto3"
inputFoto = "foto2"  # "foto1"
...
## STANDARDIZATION
print("--std: ", normalising.normalise_standardization(modelTransform_torso))
plt.figure()
plt.axis([-2, 2, -2, 2])
...
plt.plot(*zip(*normalising.normalise_standardization(secondary)), marker='o', color='b', ls='', markersize='2')
plt.plot(*zip(*normalising.normalise_standardization(modelTransform_torso)), marker='o', color='r', ls='', markersize='2')

## RESCALING
print(secondary)
secondary_scaling = normalising.normalise_rescaling(secondary)
print("sec norm full: ", secondary_scaling)
print("modeltrans norm: " , normalising.normalise_rescaling(modelTransform_torso))
...
#ax.yaxis.set_ticks(np.arange(0, 16, 1)) # set y-ticks
ax.yaxis.tick_left()                    # remove right y-Ticks
plt.plot(*zip(*secondary_scaling), marker='o', color='r', ls='', markersize='2')
plt.plot(*zip(*normalising.normalise_rescaling(modelTransform_torso)), marker='o', color='b', ls='', markersize='2')
